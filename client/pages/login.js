    ...
    return ( 
        <div>
            ...
            <form action="" id="login-form" onSubmit={ (e) => handleSubmit(e) }>
                <p id="login-para">על מנת להתחבר, יש להזין את פרטי ההתחברות שלכם:</p>
                <input type="email" value={ email } onChange={ (e) => setEmail(e.target.value) } placeholder="כתובת אימייל" />
                ...
                <div id="not-registered-msg">
                    לא רשומים? <Link href="/signup"><a href="/">הרשמה</a></Link>
                </div>
            </form>
        </div>
    );
